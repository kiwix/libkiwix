...
{
  EXPECT_EQ(maskUpdatedTimestamps(dumper->dumpOPDSFeed({"book1-id"}, "")),
...
{
  EXPECT_EQ(maskUpdatedTimestamps(dumper->dumpOPDSFeed({"book1-id"}, "lang=eng")),
    "<feed xmlns=\"http://www.w3.org/2005/Atom\"\n"
    "      xmlns:dc=\"http://purl.org/dc/terms/\"\n"
    "      xmlns:opds=\"http://opds-spec.org/2010/catalog\">\n"
...
{
  EXPECT_EQ(maskUpdatedTimestamps(dumper->dumpOPDSFeedV2({"book1-id", "book2-id"}, "", /*partial=*/false)),
...
{
  EXPECT_EQ(maskUpdatedTimestamps(dumper->dumpOPDSFeedV2({"book1-id"}, "", /*partial=*/true)),
    "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
    "<feed xmlns=\"http://www.w3.org/2005/Atom\"\n"
    "      xmlns:dc=\"http://purl.org/dc/terms/\"\n"
    "      xmlns:opds=\"https://specs.opds.io/opds-1.2\"\n"
...
{
  EXPECT_EQ(maskUpdatedTimestamps(dumper->dumpOPDSCompleteEntry("book2-id")),
    "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
    BOOK2_ENTRY
  );
}
...
TEST_F(OPDSDumperTest, categoriesOPDSFeedListsDistinctSortedCategories)
{
  ...
  // "category" attribute).
  EXPECT_EQ(maskUpdatedTimestamps(dumper->categoriesOPDSFeed()),
    "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
    "<feed xmlns=\"http://www.w3.org/2005/Atom\"\n"
    "      xmlns:opds=\"https://specs.opds.io/opds-1.2\">\n"
...
TEST_F(OPDSDumperTest, languagesOPDSFeedListsLanguagesWithCounts)
{
  ...
  EXPECT_EQ(maskUpdatedTimestamps(dumper->languagesOPDSFeed()),
    "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
    "<feed xmlns=\"http://www.w3.org/2005/Atom\"\n"
    "      xmlns:dc=\"http://purl.org/dc/terms/\"\n"
    "      xmlns:opds=\"https://specs.opds.io/opds-1.2\"\n"
