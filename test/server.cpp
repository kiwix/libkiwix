...
TEST_F(ServerTest, MimeTypes)
{
  ...
  const TestData testData[] = {
    ...
    { "/catalog/v2/languages",             "application/atom+xml;profile=opds-catalog;kind=navigation" },
    { "/catalog/v2/categories",            "application/atom+xml;profile=opds-catalog;kind=navigation" },
    { "/catalog/v2/entries",               "application/atom+xml;profile=opds-catalog;kind=acquisition" },
    { "/catalog/v2/entry/6f1d19d0-633f-087b-fb55-7ac324ff9baf", "application/atom+xml;type=entry;profile=opds-catalog" },
