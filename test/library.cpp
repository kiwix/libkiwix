...
TEST(LibraryOpdsImportTest, allInOne)
{
  ...
  EXPECT_EQ(book1.getUrl(kiwix::Book::AcquisitionLinkKind::DIRECT), "http://download.kiwix.org/zim/wikipedia/wikipedia_fr_tunisie_novid_2018-10.zim.meta4");
  ...
  EXPECT_EQ(book2.getUrl(kiwix::Book::AcquisitionLinkKind::DIRECT), "http://download.kiwix.org/zim/ted/ted_en_business_2018-07.zim.meta4");
