...
<feed xmlns="http://www.w3.org/2005/Atom"
  ...
  <entry>
    ...
    <link rel="self" href="./test/zimfile.zim" type="application/x-zim"/>
  </entry>
  <entry>
    ...
    <link rel="self" href="./test/example.zim" type="application/x-zim"/>
  </entry>
</feed>
)";
 ...
 protected:
  ...
  void loadRayCharlesAndExample(kiwix::Manager& manager) {
    if (GetParam() == "xml") {
      ...
      manager.readOpds(sampleLibraryOpds, "");
    }
  }
